...
replace (
	...
	k8s.io/kubernetes => k8s.io/kubernetes v0.34.5
	k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.34.5
...
replace github.com/rancher/wrangler/v3 => github.com/rancher/wrangler/v3 v3.7.0
